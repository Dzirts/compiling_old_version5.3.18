        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (eid) {
                case MotionEvent.ACTION_MOVE:
                    Log.i("move0 ","move0");
                    //TODO: show zoomed view of touch
...
//                    zoomedmageView.setImageMatrix(orig.getImageMatrix());
//                    Log.i("move0a ","move0a");
//                    Matrix mat = new Matrix();
//                    mat = zoomedmageView.getImageMatrix();
//                    mat.postScale(2,2,event.getX(),event.getY());
